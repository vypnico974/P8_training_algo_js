...
the examples exported add from the math_functions.js file. Here's how you can import it to
use in another file:
...
same folder as the current file. The relative file path (./) and file extension (.js) are required 
...
and lowercaseString functions you exported in the previous lesson. These functions are in a file 
