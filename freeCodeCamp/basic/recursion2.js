...
To help understand this, start by thinking about the following task: multiply the first
...
where n <= 0, it returns 1. For larger values of n, it calls itself, but with n - 1. That function
call is evaluated in the same way, calling multiply again until n <= 0. At this point, all the
