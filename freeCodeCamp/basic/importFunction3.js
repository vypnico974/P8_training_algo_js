...
In the last challenge, you learned about export default and its uses. To import
 a default export, you need to use a different import syntax. In the following example, 
...
In the following code, import the default export from the math_functions.js file, found
