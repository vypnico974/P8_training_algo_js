...
In the class, create a getter to obtain the temperature in Celsius and a setter to set 
...
class Thermostat {
  ...
  get temperature() {
    return this.convertToFahrenheit(this._fahrenheit);
  }

  set temperature(celsius) {
    this._fahrenheit = this.convertToCelsius(celsius);
  }
