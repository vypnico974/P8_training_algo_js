...
if it is true or not. Since it is true, the function returns It was true. 
...
Create an if statement inside the function to return 
Yes, that was true if the parameter wasThatTrue is true and return No, that was false otherwise. */
