...
Basically, you won't have to use concatenation with the + operator anymore. To add variables
to strings, you just drop the variable in a template string and wrap it with ${ and }. 
...
on the result object and have a class attribute with the value text-warning. The makeList function
...
const result = {
  ...
  function makeList(arr) {
    ...
    for (const items of arr ){
      failureItems.push(`<li class="text-warning">${items}</li>`)
    }
