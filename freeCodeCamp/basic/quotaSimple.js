...
However, this becomes a problem if you need to use the outermost quotes within it.
 ...
 But if you have that same quote somewhere in the middle, the string will
...
Change the provided string to a string with single quotes at the beginning and end and no escape
 characters.
